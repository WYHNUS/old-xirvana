...
class BookingTableMap extends TableMap
{
    ...
    /**
     * the column name for the bookingTime field
     */
    const COL_BOOKINGTIME = 'Booking.bookingTime';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'Booking.name';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'Booking.description';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Bookingtime', 'Name', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'bookingtime', 'name', 'description', ),
        self::TYPE_COLNAME       => array(BookingTableMap::COL_ID, BookingTableMap::COL_BOOKINGTIME, BookingTableMap::COL_NAME, BookingTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'bookingTime', 'name', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Bookingtime' => 1, 'Name' => 2, 'Description' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'bookingtime' => 1, 'name' => 2, 'description' => 3, ),
        self::TYPE_COLNAME       => array(BookingTableMap::COL_ID => 0, BookingTableMap::COL_BOOKINGTIME => 1, BookingTableMap::COL_NAME => 2, BookingTableMap::COL_DESCRIPTION => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'bookingTime' => 1, 'name' => 2, 'description' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('bookingTime', 'Bookingtime', 'TIMESTAMP', true, null, 'CURRENT_TIMESTAMP');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookingTableMap::COL_BOOKINGTIME);
            $criteria->addSelectColumn(BookingTableMap::COL_NAME);
            $criteria->addSelectColumn(BookingTableMap::COL_DESCRIPTION);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.bookingTime');
